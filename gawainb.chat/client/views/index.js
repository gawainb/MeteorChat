 ...
 */
var ctrl = new gawainb.ChatController();

/*
 * subscribe chat from server with criteria from controller and sort limit from controller
 * when template created
 */
Template.gawainb_chatIndex.onCreated(function() {
    var self = this;
    self.autorun(function() {
        self.subscribe('gawainb_chat', ctrl.getCriteria(), ctrl.getSortLimit());
    });
});

Template.gawainb_chatIndex.helpers({
...
Template.gawainb_chatIndex.events = {
