 ...
 * in my case is gawainb who is my meteor username, and
 * Chat as collection name
 */
Namespace('gawainb.Chat');

/*
 * create new mongo collection
 * in my case my collection name will be "gawainb_chat"
 * this is to avoid crash between another collection name called "chat"
 */
gawainb.Chat = new Mongo.Collection("gawainb_chat");
...
gawainb.Chat.attachSchema(schemas);
