 ...
 * gawainb as my meteor username/module, and
 * ChatController for my controllername
 */
Namespace('gawainb.ChatController');
 ...
 */
gawainb.ChatController = Meteoris.Controller.extend({
    /*
    ...
    getAll: function() {
        return gawainb.Chat.find(this.getCriteria(), this.getSortLimit());
    },
    ...
    post: function(t) {
        ...
        gawainb.Chat.insert(doc, function(err, _id) {
            if (err) {
